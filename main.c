...
#include <string.h>
int main(){
    printf("...................WELCOME TO THE GAME 'ALPHABETICAL ANTICS'...................\n");
    printf(".........................presented by Anshika Saklani...................\n");
    int p=1;
    int choice;
    while(p){                                                                    
        ...
        if (choice==1){
            ...
            printf("Enter another word that need to be checked: ");
            scanf("%s", str1);
            len1 = strlen(input);
            len2 = strlen(str1);
            if (len1 != len2) {
            ...
            int i = 0,f=0;
            char text;
            printf("Enter your text (without the letter 'e'): ");
            scanf("%c", &text);
            while (input[i] != '\0') {
                if (input[i] != text ) {
                    f=1;
